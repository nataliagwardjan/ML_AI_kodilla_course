...
if __name__ == "__main__":
   ...
   select_all_projects = select_all(conn, "projects")
   select_all_tasks = select_all(conn, "tasks")

   print(select_all_projects)
   print(select_all_tasks)

   select_task_id_1 = select_where(conn, "tasks", project_id=1)

   print(select_task_id_1)
